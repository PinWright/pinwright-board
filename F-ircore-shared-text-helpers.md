...
New file `Plugins/PinWright/Source/PinWright/Public/IrCore/IrTextUtils.{h,cpp}`. Sits next to existing `IrCore/IrTokenizer`, `IrCore/IIrGrammar`, `IrCore/IrTypeSpec`, `IrCore/IrCompileDiagnostic`. No new module dependency needed; everything is core UE.
