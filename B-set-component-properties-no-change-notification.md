...
| `UShapeComponent` (Box/Sphere/Capsule) | `BoxExtent`, `SphereRadius`, `CapsuleHalfHeight`, … | `UpdateBodySetup()` — **collision keeps the old shape while the wireframe shows the new one** | `ShapeComponent.cpp:157-162` |
