...
`AnimSequenceDumpBuilder::BuildAnimSequenceJson` (`Source/PinWright/Private/Handlers/Asset/AnimSequenceDumpBuilder.cpp`) emits a richer per-sequence shape than the live introspection RPC. The dump exposes:
