...
`CoerceStringToPersistedFText` in `Utils/PropertyUtils.cpp:916` rejects
plain strings (`"Persisted FText values require a non-empty namespace
and key..."`, line 952) unless an existing localized value is being
overwritten in place. `FCodeNodeEmitter::CreateFormatTextNode`
