...
- Decompile side: `FBpirDecompiler::FormatPinDefaultLiteral` in
  `Source/EditorAutomationRpcGateway/Private/Decompiler/BpirDecompiler.cpp:2122-2234`
...
- Compile side: `FBpirValueResolver::IsLiteral` in
  `Source/EditorAutomationRpcGateway/Private/Compiler/BpirValueResolver.cpp:673`
